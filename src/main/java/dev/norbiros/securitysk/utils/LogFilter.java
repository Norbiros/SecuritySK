package dev.norbiros.securitysk.utils;

import dev.norbiros.securitysk.*;
...
public class LogFilter implements Filter {
    private static ArrayList<String> hidedLogs = new ArrayList<String>();

    public LogFilter() {}
    public void addCommand(String string) { this.hidedLogs.add(string);}
    public void removeCommand(String string) { this.hidedLogs.remove(string); }

    public Filter.Result checkMessage(String message) {
        try {
            for (String msg : hidedLogs) {
